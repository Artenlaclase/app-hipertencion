...
abstract class MedicationRemoteDataSource {
  ...
  Future<MedicationModel> updateMedication(String id, Map<String, dynamic> data);
  Future<void> deleteMedication(String id);
  // Alarms
  Future<MedicationAlarmModel> createAlarm(String medicationId, Map<String, dynamic> data);
  Future<MedicationAlarmModel> updateAlarm(String alarmId, Map<String, dynamic> data);
  Future<void> deleteAlarm(String alarmId);
  // Logs
  Future<List<MedicationLogModel>> getMedicationLogs(String medicationId);
  Future<MedicationLogModel> createMedicationLog(String medicationId, Map<String, dynamic> data);
  // Adherence
...
class MedicationRemoteDataSourceImpl implements MedicationRemoteDataSource {
  ...
  Future<MedicationModel> createMedication(Map<String, dynamic> data) async {
    ...
    final medData = response is Map<String, dynamic> && response.containsKey('data')
        ? response['data']
        : response;
  ...
  @override
  Future<MedicationModel> updateMedication(String id, Map<String, dynamic> data) async {
    final response = await apiClient.put('${ApiConstants.medications}/$id', body: data);
    final medData = response is Map<String, dynamic> && response.containsKey('data')
        ? response['data']
        : response;
    return MedicationModel.fromJson(medData);
  ...
  @override
  Future<MedicationAlarmModel> createAlarm(String medicationId, Map<String, dynamic> data) async {
    final response = await apiClient.post(
      '${ApiConstants.medications}/$medicationId/alarms',
      body: data,
    );
    final alarmData = response is Map<String, dynamic> && response.containsKey('data')
        ? response['data']
        : response;
  ...
  @override
  Future<MedicationAlarmModel> updateAlarm(String alarmId, Map<String, dynamic> data) async {
  ...
  @override
  Future<List<MedicationLogModel>> getMedicationLogs(String medicationId) async {
    final response = await apiClient.get('${ApiConstants.medications}/$medicationId/logs');
    final List<dynamic> data = response is Map && response.containsKey('data')
        ? response['data']
        : (response is List ? response : []);
  ...
  @override
  Future<MedicationLogModel> createMedicationLog(String medicationId, Map<String, dynamic> data) async {
    final response = await apiClient.post(
